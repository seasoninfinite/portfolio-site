...
function DotMark() {
  return (
    <a
      ...
      className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-white/15 bg-white/[0.06] text-[12px] leading-none font-semibold tracking-normal text-gray-200 transition-colors hover:bg-white/10 hover:text-white"
    >
      BGG
    </a>
  );
